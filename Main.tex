...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://alfredohernandez.github.io}{\Large Jesús Alfredo Hernández Alarcón}} & \textbf{Email:} \href{mailto:alfredo.h.alarcon@icloud.com}{alfredo.h.alarcon@icloud.com}\\
  
  \href{https://alfredohernandez.github.io}{https://alfredohernandez.github.io} & \textbf{Mobile:} +52 55 7080 7972 \\
...
Alfredo is a Software Engineer with experience in mobile development using mainly agile methodologies. Experience with all Apple ecosystem, with Swift language and TDD methodology.
...
\section{Employment history and experience}
  ...
  \resumeSubheading
      {Ualá}{Mexico City, MX}
      {iOS Software Engineer}{Nov 2021 - Present}
      \resumeItemListStart
        \resumeItemSimple{Working on the onboarding feature for the 3 countries (ARG, MEX and CO), integrating authentication with biometrics using the apple SDK and third party SDK.}
        \resumeItemSimple{Using TDD as strategy for the onboarding development.}
        \resumeItemSimple{Working on migration for some UIKit views to SwiftUI views. Updating new iOS APIs as async/await, combine, use new swift language features.}
        \resumeItemSimple{Developed a feature called Screen Provider to serve screens on demand using JSON files to create dynamic flows, working with the design team, product owners and other developers to create a standard to be reusable across the app.}
        \resumeItemSimple{Working on app improvements like performance on local storage, app cache, feature flagging, analytics}
      \resumeItemListEnd
